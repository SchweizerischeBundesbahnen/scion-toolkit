...
import {SciInternalIconComponent} from './scion-icon-provider';
...
describe('Built-in Icon Providers', () => {
  ...
  it('should render SCION icon', async () => {
    ...
    await expectIcon(fixture).toDisplay({component: SciInternalIconComponent, innerText: 'close'});

    // Expect icon to have the SCION icon font.
    const scionIconComponent = fixture.debugElement.query(By.directive(SciInternalIconComponent)).nativeElement as HTMLElement;
