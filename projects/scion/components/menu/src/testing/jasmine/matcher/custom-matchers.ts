...
import {ExpectedMenuPosition} from './to-have-menu-position.matcher';
import {ExpectedSciMenuItemLike} from './custom-matcher.model';
...
declare global {
  namespace jasmine {
    interface AsyncMatchers<T, U> {
      ...
      toEqualMenubar(expected: ExpectedSciMenuItemLike[], expectationFailOutput?: any): Promise<void>;

      toHaveMenuPosition(expected: ExpectedMenuPosition, expectationFailOutput?: any): Promise<void>;
    }
  }
}
