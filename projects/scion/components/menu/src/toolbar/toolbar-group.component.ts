...
export class SciToolbarGroupComponent {
   ...
   */
  public readonly menuOpen = this.computeMenuOpen();

  private readonly _childToolbarGroups = viewChildren(SciToolbarGroupComponent);
   ...
   */
  private computeMenuOpen(): Signal<boolean> {
