...
function getLabelIfText(label: MaybeSignal<Translatable> | ComponentType<unknown> | SciComponentDescriptor | undefined): MaybeSignal<Translatable> | undefined {
...
function getLabelIfComponent(label: MaybeSignal<Translatable> | ComponentType<unknown> | SciComponentDescriptor | undefined): SciComponentDescriptor | undefined {
...
function getIconIfComponent(icon: MaybeSignal<Translatable> | ComponentType<unknown> | SciComponentDescriptor | undefined): SciComponentDescriptor | undefined {
