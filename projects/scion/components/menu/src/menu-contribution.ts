...
/**
 * Contributes tools to a {@link SciToolbarComponent} (or toolbar group) with the given name.
 *
 ...
 *
 * Menus can have a name, enabling extension from other contributions.
 *
 * This function must be called within an injection context, or an explicit {@link Injector} passed. The contribution is disposed when the injection context or the passed injector is destroyed.
 *
...
/**
 * Contributes menu items to a menu (or menu group) with the given name.
 *
