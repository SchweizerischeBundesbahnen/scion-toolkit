...
describe('Menu', () => {
  ...
  it('should contribute complex menu', async () => {
    TestBed.configureTestingModule({
      providers: [
        {provide: ComponentFixtureAutoDetect, useValue: true},
      ],
  ...
  it('should not federate contributions again', async () => {
    ...
    contributeMenu({location: 'menu:submenu-2'}, menu => menu
      .addMenuItem({label: 'label-99', onSelect: noop})
    ...
    // Open submenu 1.
    const fileMenu = await menu.openSubMenu({cssClass: 'submenu-1'});

    // Open submenu 2.
    await fileMenu.openSubMenu({cssClass: 'submenu-2'});
  ...
  it('should close child menu when filtering', async () => {
    ...
    // Contribute to menu.
    contributeMenu('menu:testee', menu => {
      menu.addMenu({label: 'label', cssClass: 'submenu'}, menu => menu.addMenuItem({label: 'label', onSelect: noop}));
    }, {injector: TestBed.inject(Injector)});
    await fixture.whenStable();
    ...
    await expectAsync(subMenu).not.toBeAttached();
  });
  ...
  describe('Menu Item', () => {
    ...
    it('should provide disabled', async () => {
      ...
      contributeMenu('menu:testee', menu => menu
        ...
        .addMenuItem({disabled: false, label: 'label', onSelect: noop}), {injector: TestBed.inject(Injector)});
      await fixture.whenStable();
    ...
    it('should provide checked', async () => {
      ...
      contributeMenu('menu:testee', menu => menu
        ...
        .addMenuItem({checked: false, label: 'label', onSelect: noop}), {injector: TestBed.inject(Injector)});
      await fixture.whenStable();
    ...
    it('should provide active', async () => {
      ...
      contributeMenu('menu:testee', menu => menu
        ...
        .addMenuItem({active: false, label: 'label', onSelect: noop}), {injector: TestBed.inject(Injector)});
      await fixture.whenStable();
    ...
    it('should invoke onSelect callback on pressing keystroke', async () => {
      ...
      // Contribute to menu.
      contributeMenu('menu:testee', menu => menu
        .addMenuItem({label: 'testee-1', cssClass: 'testee-1', accelerator: {alt: true, key: '1'}, onSelect: () => console.log('Click item 1')})
        .addMenuItem({label: 'testee-2', cssClass: 'testee-2', accelerator: {alt: true, key: '2'}, onSelect: () => console.log('Click item 2')}), {injector: TestBed.inject(Injector)});
      await fixture.whenStable();
  ...
  describe('Submenu', () => {
    ...
    it('should provide disabled', async () => {
      ...
      contributeMenu('menu:testee', menu => menu
        ...
        .addMenu({disabled: false, label: 'label'}, menu => menu.addMenuItem({label: 'label', onSelect: noop})), {injector: TestBed.inject(Injector)});
      await fixture.whenStable();
    ...
    describe('Filter', () => {
      ...
      it('should provide filter (omit filter option)', async () => {
        ...
        // Contribute to menu.
        contributeMenu('menu:testee', menu => menu
          .addMenu({label: 'label', cssClass: 'testee'}, menu => menu
            .addMenuItem({label: 'label', onSelect: noop})), {injector: TestBed.inject(Injector)});
        await fixture.whenStable();
      ...
      it('should provide filter (filter=false)', async () => {
        ...
        // Contribute to menu.
        contributeMenu('menu:testee', menu => menu
          .addMenu({menu: {filter: false}, label: 'label', cssClass: 'testee'}, menu => menu
            .addMenuItem({label: 'label', onSelect: noop})), {injector: TestBed.inject(Injector)});
        await fixture.whenStable();
      ...
      it('should provide filter (filter=true)', async () => {
        ...
        // Contribute to menu.
        contributeMenu('menu:testee', menu => menu
          .addMenu({menu: {filter: true}, label: 'label', cssClass: 'testee'}, menu => menu
            .addMenuItem({label: 'label', onSelect: noop})), {injector: TestBed.inject(Injector)});
        await fixture.whenStable();
      ...
      it('should provide filter (notFoundText)', async () => {
        ...
        // Contribute to menu.
        contributeMenu('menu:testee', menu => menu
          .addMenu({menu: {filter: {notFoundText: 'testee-not-found-text'}}, label: 'label', cssClass: 'testee'}, menu => menu
            .addMenuItem({label: 'label', onSelect: noop})), {injector: TestBed.inject(Injector)});
        await fixture.whenStable();
  ...
  describe('Group', () => {
    ...
    it('should provide label', async () => {
      ...
      // Contribute to menu.
      contributeMenu('menu:testee', menu => menu
        .addGroup({label: 'testee'}, group => group.addMenuItem({label: 'label', onSelect: noop})), {injector: TestBed.inject(Injector)});
      await fixture.whenStable();
    ...
    it('should provide disabled', async () => {
      ...
      contributeMenu('menu:testee', menu => menu
        ...
        .addGroup({disabled: false}, group => group.addMenuItem({label: 'label', onSelect: noop})), {injector: TestBed.inject(Injector)});
      await fixture.whenStable();
...
export function drawAnchorPoint(anchor: {x: number; y: number}): HTMLElement {
