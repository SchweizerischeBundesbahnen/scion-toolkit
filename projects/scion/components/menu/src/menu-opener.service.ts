...
import {ApplicationRef, Binding, ComponentRef, createComponent, DestroyRef, DOCUMENT, ElementRef, EnvironmentInjector, inject, Injectable, Injector, inputBinding, runInInjectionContext, signal, Signal, ViewContainerRef} from '@angular/core';
  ...
  private createMenuPopover(menuItems: Signal<SciMenuItemLike[]>, anchorElement: HTMLElement, options: SciMenuOptions): ComponentRef<SciMenuComponent> {
    ...
    const componentRef = (() => {
      ...
      if (options.viewContainerRef) {
        ...
        anchorElement.after(componentRef.location.nativeElement as Element);
