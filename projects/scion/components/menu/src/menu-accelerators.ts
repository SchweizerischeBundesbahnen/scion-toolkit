...
export interface SciMenuAcceleratorOptions {
   ...
   *
   * Accelerators are automatically uninstalled when the passed injector is destroyed.
   */
  injector?: Injector;
}
...
export interface ɵSciMenuAcceleratorOptions {
  ...
  /**
   * Specifies the handler invoked when an accelerator is triggered. Defaults to invoking {@link SciMenuItem.onSelect}.
   */
