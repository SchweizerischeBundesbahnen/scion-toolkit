...
@Injectable()
export class SciTableColumnService {
  ...
  public startResize(column: SciTableColumnLike): void {
   ...
   */
  private updateUserSettings(resizedColumn: SciTableColumnLike): void {
   ...
   */
  private calculateColumnWidths(columnToResize: SciTableColumnLike, newColumnWidth: number | 'min-content'): Map<`column:${string}`, number | 'min-content'> {
