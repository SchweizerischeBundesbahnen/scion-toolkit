...
describe('Built-in Text Provider', () => {
  ...
  it('should provide built-in text', () => {
    const translated = text('%scion.components.menu.no_items.message', {injector: TestBed.inject(Injector)});
  ...
  it('should provide custom text', () => {
    ...
    const text2 = text('%scion.components.menu.no_items.message', {injector: TestBed.inject(Injector)});
