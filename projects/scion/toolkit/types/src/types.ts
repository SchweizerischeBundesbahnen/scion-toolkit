...
/**
 * Represents a value or an {@link Observable} of that value.
 */
...
export interface Disposable {
  /**
   * Disposes the object, releasing any allocated resources.
   */
  dispose(): void;
}

/**
 * Signature of a function to free allocated resources.
 */
