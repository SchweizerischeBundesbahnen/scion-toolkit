...
describe('prune', () => {
  ...
  describe('prune(object)', () => {
    ...
    it('should delete `undefined` values (recursive=true, pruneIfEmpty=true) (only `undefined` and empty values)', () => {
      ...
      expect(prune(object, {recursive: true, pruneIfEmpty: true})).toBeUndefined();
    });
  ...
  describe('prune(Map)', () => {
    ...
    it('should delete `undefined` values (recursive=true, pruneIfEmpty=true) (only `undefined` and empty values)', () => {
      ...
      expect(prune(map, {recursive: true, pruneIfEmpty: true})).toBeUndefined();
    });
  ...
  describe('prune(Set)', () => {
    ...
    it('should delete `undefined` values (recursive=true, pruneIfEmpty=true) (only `undefined` and empty values)', () => {
      ...
      expect(prune(set, {recursive: true, pruneIfEmpty: true})).toBeUndefined();
    });
  ...
  describe('prune(Array)', () => {
    ...
    it('should delete `undefined` values (recursive=true, pruneIfEmpty=true) (only `undefined` and empty values)', () => {
      ...
      expect(prune(array, {recursive: true, pruneIfEmpty: true})).toBeUndefined();
    });
  ...
  it('should preserve object type and undefined (no type error)', () => {
    const map = undefined as unknown as Map<string, undefined> | undefined;
