...
export namespace Maps {
   ...
   */
  export function coerce<T = any>(mapLike: Map<string, T> | Dictionary<T> | undefined | null, options?: {coerceNullOrUndefined: true} | object): NonNullable<Map<string, T>>;
  ...
  export function coerce<T = any>(mapLike: Map<string, T> | Dictionary<T> | undefined | null, options?: {coerceNullOrUndefined?: boolean}): Map<string, T> | null | undefined {
    ...
    return Object // eslint-disable-line @typescript-eslint/no-unsafe-return
      .entries(mapLike)
      .reduce(
