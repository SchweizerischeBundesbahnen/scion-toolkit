...
* **components/icon:** provide text provider API ([40bba49](https://github.com/SchweizerischeBundesbahnen/scion-toolkit/commit/40bba49f56cbfae6a90e3e227b1c67d964551c64))
...
* **components:** SCION Components requires icons to be loaded from the following CDN: https://cdn.jsdelivr.net/npm/@scion/components/resources/scion-icons. 
