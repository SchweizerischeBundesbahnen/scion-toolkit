...
export default class SciToolbarPageComponent {
  ...
  private contributeToolbar(): void {
    ...
    contributeMenu('toolbar:demo', toolbar => toolbar
      .addToolbarMenu({label: 'File', disabled: true, cssClass: 'file-menu'}, menu => menu
      ...
      .addToolbarSplitControl({component: InputToolbarControlComponent, bindings: [inputBinding('placeholder', signal('Enter to filter'))]}, menu => menu
        ...
        .addMenuItem({label: 'Italic', disabled: true, onSelect: () => italic.update(italic => !italic)})
      ...
      .addToolbarMenu({icon: 'palette', visualMenuIndicator: true, menu: {filter: true}}, menu => menu
        .addGroup(group => group
          ...
          .addMenuItem({label: 'Italic', accelerator: {ctrl: true, alt: true, key: 'U'}, actions: toolbar => toolbar.addToolbarButton({icon: 'home', onSelect}), onSelect: () => italic.update(italic => !italic)})
        ...
        menuItems().forEach(menuItem => {
          menu.addMenuItem({
            ...
            actions: actions => actions
              .addToolbarMenu({icon: 'more_vert'}, menu => menu.addMenuItem({label: 'Hello', onSelect}))
              .addToolbarButton({
                icon: 'scion.close',
                tooltip: 'Close',
